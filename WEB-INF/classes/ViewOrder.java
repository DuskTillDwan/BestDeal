...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("Order")!=null && request.getParameter("Order").equals("CancelOrder"))
		{
			...
			for (OrderPayment oi : orderPayments.get(orderId)) 
				{
						if(oi.getOrderName().equals(orderName))
						{
							 ...
							 //MySqlDataStoreUtilities helper = new MySqlDataStoreUtilities();
							 //OrderPayment op = new OrderPayment(oi.getOrderId(), oi.getUserName(), oi.getOrderName(), oi.getOrderPrice(), oi.getUserAddress(), oi.getCreditCardNo());
							 //helper.deleteOrderPayment(op);
			...
			//int orderId,String userName,String orderName,double orderPrice,String userAddress,String creditCardNo
			try
			{	
