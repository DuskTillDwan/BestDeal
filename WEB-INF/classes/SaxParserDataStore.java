...
public class SaxParserDataStore extends DefaultHandler {
    ...
    String teleivisionXmlFileName;
    String elementValueRead;
	String currentElement="";
    public SaxParserDataStore()
	{
	}
	public SaxParserDataStore(String teleivisionXmlFileName) {
    this.teleivisionXmlFileName = teleivisionXmlFileName;
   ...
   //parse the xml using sax parser to get the data
    private void parseDocument() 
	{
	    ...
	    parser.parse(teleivisionXmlFileName, this);
...
////////////////////////////////////////////////////////////
	...
	// when xml start element is parsed store the id into respective hashmap for television,laptops etc 
    @Override
	...
	// when xml end element is parsed store the data into respective hashmap for television,laptops etc respectively
    @Override
