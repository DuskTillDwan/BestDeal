...
public class Utilities extends HttpServlet{
	...
	public void storeProduct(String name,String type,String maker, String acc){
		...
		if(type.equals("smartphones")){	
			Smartphone smartphone = SaxParserDataStore.smartphones.get(name); 
	...
	public void storePayment(int orderId,
		...
		helper.addOrderPayment(orderpayment);
	...
	/* getTelevisions Functions returns the Hashmap with all televisions in the store.*/
	...
	public ArrayList<String> getProductsSmartphones(){		
		ArrayList<String> ar = new ArrayList<String>();
